...
export interface paths {
    ...
    "/api/courses/{course_id}/documents/convert-url": {
        ...
        put?: never;
        /**
         * Scrape a URL and return a preview PDF
         * @description Scrape a URL with Playwright/Chromium and return the rendered PDF for review.
         *
         ...
         */
        post: operations["convert_url_to_pdf_api_courses__course_id__documents_convert_url_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/courses/{course_id}/documents/confirm-url-pdf": {
        ...
        put?: never;
        /**
         * Confirm and ingest a URL-converted PDF
         * @description Confirm a previously generated URL PDF and feed it into the pipeline.
         *
         ...
         */
        post: operations["confirm_url_pdf_api_courses__course_id__documents_confirm_url_pdf_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
         ...
         * @description Returned by POST /flashcards/generate when a request for the target is
        ...
        /**
         * URLPDFConfirmRequest
         * @description Request body for POST /api/courses/{course_id}/documents/confirm-url-pdf.
         *
        ...
        /**
         * URLRequest
         * @description Request body for POST /api/courses/{course_id}/documents/convert-url.
         *
...
export interface operations {
    ...
    convert_url_to_pdf_api_courses__course_id__documents_convert_url_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            /** @description PDF bytes. Includes X-Temp-Id, X-Filename, and X-Expires-At response headers. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Invalid URL scheme or URL not reachable */
            400: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Page load timed out */
            408: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description URL-to-PDF service unavailable */
            503: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    confirm_url_pdf_api_courses__course_id__documents_confirm_url_pdf_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["URLPDFConfirmRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    generate_flashcards_endpoint_api_v1_flashcards_generate_post: {
        ...
        responses: {
            ...
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["FlashcardResponse"][] | components["schemas"]["FlashcardRequestResponse"];
                };
            };
            /** @description Validation Error */
            422: {
